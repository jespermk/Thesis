...
import torch as t
from VI_models.simple_models import MFG, exponential_radial
...
if t.cuda.is_available():
    ...
    device = 'cpu'
epoch_n = t.tensor(150) # -> 240
batch_size = 100  # -> 64
dataset_size = 60000

# Normal
model = 'exp_radial_FM_less'
m_normal = radial_VCL_image_model(exponential_radial, device=device, other_prior=MFG)
m_normal.to(device)
